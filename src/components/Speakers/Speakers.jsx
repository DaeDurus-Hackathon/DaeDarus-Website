    ...
    return (
        ...
        <br></br>
            ...
            <Row className="my-5">
                ...
                <Col><img class="speak-logos" src={pratyush}/><h2>Pratyush Agarwal</h2><h5>Founder & CEO at CodeAsylums, Bangalore, India</h5><SocialIcon url="https://www.linkedin.com/in/pratsy/" target="_blank"/></Col>
            </Row>
            <Row className="my-5">
